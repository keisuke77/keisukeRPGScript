...
{ 
  public static SimpleMeshExploder SimpleMeshExploder;
  public static message[] allMessage;
  public static AutoRotateCamera[] AutoRotateCameraAll;
...
public static GameObject instantiate(GameObject obj,Transform trans){

 var o= Instantiate(obj,trans.position,trans.rotation);
  return o;
}
public static GameObject instantiate(GameObject obj,Transform trans,bool parent){
...
public static void Lookingtarget(GameObject
from ,GameObject to){
...
public static void forwardforce(GameObject shoter,GameObject shottarget){
    ...
    public static void deatheventset(GameObject self,UnityEvent events){
